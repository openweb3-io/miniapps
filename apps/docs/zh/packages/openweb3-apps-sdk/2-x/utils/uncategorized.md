...
- `text?: string` - 要添加到媒体中的标题，普通
  用户的限制为 0-200 个字符，[高级用户](https://openweb3.io/faq_premium#openweb3-premium) 的限制为 0-2048 个字符
  。
- `widgetLink?: object` - 用于在故事中加入 widget 链接的对象。
  只有 [高级用户](https://openweb3.io/faq_premium#openweb3-premium) 才能发布带有链接的故事
  。
