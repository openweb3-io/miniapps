...
```ts [Variable]
import { mainButton } from '@openweb3-apps/sdk';
...
```ts [Functions]
import { mountMainButton, isMainButtonMounted } from '@openweb3-apps/sdk';
...
```ts [Functions]
import { unmountMainButton, isMainButtonMounted } from '@openweb3-apps/sdk';
