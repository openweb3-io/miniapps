import { parseInitData, isTMA, mockOpenweb3Env } from '@openweb3-apps/sdk-react';

import { useClientOnce } from '@/hooks/useClientOnce';

/**
 * Mocks Openweb3 environment in development mode.
 */
export function useOpenweb3Mock(): void {
  useClientOnce(() => {
