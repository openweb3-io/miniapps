...
import { mockOpenweb3Env } from './mockOpenweb3Env.js';
...
it('should wire window.Openweb3WebviewProxy.postEvent', () => {
  const wiredPostEvent = vi.fn();
  createWindow({ Openweb3WebviewProxy: { postEvent: wiredPostEvent } } as any);
  mockOpenweb3Env(lp);
